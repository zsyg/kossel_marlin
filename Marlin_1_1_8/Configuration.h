...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 75.0 // mm //was 87.5 now 75 due to 

  #if ENABLED(DELTA_AUTO_CALIBRATION) || ENABLED(DELTA_CALIBRATION_MENU)
    // Set the radius for the calibration probe points - max 0.9 * DELTA_PRINTABLE_RADIUS for non-eccentric probes
    #define DELTA_CALIBRATION_RADIUS (0.9*DELTA_PRINTABLE_RADIUS) // mm
  ...
  #define DELTA_HEIGHT 268.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 108.0 //mm  Get this value from auto calibrate
 ...
 */
 ...
 #define E_FULL_STEPS_PER_ROTATION 200 //Stepper motor weekly number of steps, namely 360 / stepper motor angle
 #define E_MICROSTEPS 16 //Breakdown of the number of stepper drive
 #define E_PITCH 0.666666666666666666 // Pitch
 #define E_PULLEY_TEETH 32 //Synchronization number of teeth
 #define E_STEPS (E_FULL_STEPS_PER_ROTATION * E_MICROSTEPS / double(E_PITCH) / double(E_PULLEY_TEETH))
 //This is the formula: number of subdivisions number * stepping stepper motor driver / tooth spacing / synchronous tooth number
 
 #define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS*100/100, XYZ_STEPS*100/100, XYZ_STEPS*100/100, 152.02}   //Extruder amount - E_STEPS was 150 FLSUN original extruder
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -23.2  // Y offset: -front +behind [the nozzle]
